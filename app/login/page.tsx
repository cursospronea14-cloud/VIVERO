...
export default function LoginPage() {
  ...
  const infoCards = [
    { title: '🌵 Consejo de Cuidado', text: 'Riega tus cactus solo cuando la tierra esté completamente seca. En invierno, reduce la frecuencia.', icon: '💧', color: '#2D6A4F' },
    { title: '🎁 Promoción Especial', text: 'Lleva 3 macetas y paga 2. Válido hasta fin de mes.', icon: '🎁', color: '#E76F51' },
    { title: '⭐ Producto Destacado', text: 'Suculenta Echeveria - Ideal para principiantes, resistente y hermosa.', icon: '⭐', color: '#1B4332' },
    ...
    { title: '📦 Envíos', text: 'Realizamos envíos a toda Guatemala. Pregunta por tu zona.', icon: '🚚', color: '#E76F51' },
  ]
  ...
  return (
    <div className="min-h-screen flex">
      {/* Panel izquierdo - Fondo con patrón sutil de cactus */}
      <div 
      ...
      >
        {/* Patrón de fondo de cactus (opacidad 5%) */}
        ...
        <div className="text-center max-w-md relative z-10">
          ...
          {/* Vista previa del dashboard (difuminada) */}
        ...
        <div className="max-w-md mx-auto w-full">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <form onSubmit={handleLogin} className="space-y-5">
              ...
              {/* Campo Password con icono y mostrar/ocultar */}
              <div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-[#1B4332] text-white py-3 rounded-xl font-semibold hover:bg-[#2D6A4F] transition-all duration-300 shadow-md hover:shadow-lg hover:-translate-y-0.5 disabled:opacity-50 disabled:hover:translate-y-0"
              >
